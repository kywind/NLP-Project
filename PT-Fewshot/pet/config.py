...
class TrainConfig(PetConfig):
    ...
    def __init__(self,
        ...
        self.adv_train_batch_size = adv_train_batch_size
        self.adv_train_epochs = adv_train_epochs
...
class EvalConfig(PetConfig):
    ...
    def __init__(self,
        ...
        self.eval_data_selection = eval_data_selection
...
class AdversarialConfig(PetConfig):
    def __init__(self,
