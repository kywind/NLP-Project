...
class PVP(ABC):
    ...
    def encode(self, example: InputExample, priming: bool = False, labeled: bool = False) \
        ...
        parts_a, parts_b, block_flag_a, block_flag_b, text_a_flag_a, text_b_flag_a = self.get_parts(example)
        ...
        if text_a_flag_a is not None and text_b_flag_a is not None:
            assert len(parts_a) == len(text_a_flag_a)
            assert len(parts_a) == len(text_b_flag_a)
            text_a_flag_a = [flag for (part, _), flag in zip(parts_a, text_a_flag_a) for _ in part]
            # print(text_b_flag_a)
            # for idx, ((part, _), flag) in enumerate(zip(parts_a, text_b_flag_a)):
            #     print(idx)
            #     print(part)
            #     print(flag)
            text_b_flag_a = [flag for (part, _), flag in zip(parts_a, text_b_flag_a) for _ in part]
            # print(text_b_flag_a)
            assert len(tokens_a) == len(text_a_flag_a)
            assert len(tokens_a) == len(text_b_flag_a)
        ...
        if tokens_b:
            ...
            if text_a_flag_a is not None and text_b_flag_a is not None:
                text_a_flag = tokenizer.build_inputs_with_special_tokens(text_a_flag_a)
                text_b_flag = tokenizer.build_inputs_with_special_tokens(text_b_flag_a)
            else:
                text_a_flag = None
                text_b_flag = None
        ...
        return input_ids, token_type_ids, block_flag, text_a_flag, text_b_flag
...
class RtePVP(PVP):
    ...
    def get_parts(self, example: InputExample) -> FilledPattern:
        ...
        if self.pattern_id == 1:
            ...
            return string_list_a, string_list_b, block_flag_a, block_flag_b, None, None
...
class BoolQPVP(PVP):
    ...
    def get_parts(self, example: InputExample) -> FilledPattern:
        ...
        if self.pattern_id == 1:
            ...
            block_flag_b = []
            text_a_flag = [1, 0, 0, 0, 0, 0, 0, 0]
            text_b_flag = [0, 0, 0, 0, 1, 0, 0, 0]
            assert len(string_list_a) == len(block_flag_a)
            assert len(string_list_b) == len(block_flag_b)
            return string_list_a, string_list_b, block_flag_a, block_flag_b, text_a_flag, text_b_flag
...
class MultiRcPVP(PVP):
    ...
    def get_parts(self, example: InputExample) -> FilledPattern:
        ...
        if self.pattern_id == 1:
            ...
            block_flag_a = [0, 0, 0, 0, 0, 0, 1, 0, 0]
            block_flag_b = []
            text_a_flag = [1, 0, 0, 0, 0, 0, 0, 0, 0]
            text_b_flag = [0, 0, 1, 0, 0, 0, 0, 0, 0]
            assert len(string_list_a) == len(block_flag_a)
            assert len(string_list_b) == len(block_flag_b)
            return string_list_a, string_list_b, block_flag_a, block_flag_b, text_a_flag, text_b_flag
...
class WicPVP(PVP):
    ...
    def get_parts(self, example: InputExample) -> FilledPattern:
        ...
        if self.pattern_id == 1:
            ...
            block_flag_b = []
            text_a_flag = [1, 0, 0, 0, 0, 0]
            text_b_flag = [0, 0, 1, 0, 0, 0]
            assert len(string_list_a) == len(block_flag_a)
            assert len(string_list_b) == len(block_flag_b)
            return string_list_a, string_list_b, block_flag_a, block_flag_b, text_a_flag, text_b_flag
            ...
            block_flag_b = []
            text_a_flag = [1, 0, 0, 0, 0, 0, 0]
            text_b_flag = [0, 0, 1, 0, 0, 0, 0]
            assert len(string_list_a) == len(block_flag_a)
            assert len(string_list_b) == len(block_flag_b)
            return string_list_a, string_list_b, block_flag_a, block_flag_b, text_a_flag, text_b_flag
            ...
            block_flag_b = []
            text_a_flag = [0, 1, 0, 0, 0, 0, 0, 0]
            text_b_flag = [0, 0, 0, 1, 0, 0, 0, 0]
            assert len(string_list_a) == len(block_flag_a)
            assert len(string_list_b) == len(block_flag_b)
            return string_list_a, string_list_b, block_flag_a, block_flag_b, text_a_flag, text_b_flag
            ...
            block_flag_b = []
            text_a_flag = [0, 1, 0, 0, 0, 0, 0, 0, 0]
            text_b_flag = [0, 0, 0, 1, 0, 0, 0, 0, 0]
            assert len(string_list_a) == len(block_flag_a)
            assert len(string_list_b) == len(block_flag_b)
            return string_list_a, string_list_b, block_flag_a, block_flag_b, text_a_flag, text_b_flag
        else:
